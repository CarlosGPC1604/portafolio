  ...
  return (
    <>
      ...
      >
        ...
        <Heading as="h1" size="8" className="bg-gradient-to-b from-white via-slate-50 to-gray-300 inline-block text-transparent bg-clip-text mb-2">Portafolio.</Heading>
        <Button size="4" className="">Mis proyectos</Button>
      </main>
    </>
  );
}
